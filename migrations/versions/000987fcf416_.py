...
Revision ID: 000987fcf416
Revises: c96f85f0d7b4
Create Date: 2024-10-25 08:19:07.048417
...
revision = '000987fcf416'
down_revision = 'c96f85f0d7b4'
branch_labels = None
depends_on = None
...
def downgrade_():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('registrations', schema=None) as batch_op:
        batch_op.add_column(sa.Column('under21_age', sa.INTEGER(), autoincrement=False, nullable=True))
