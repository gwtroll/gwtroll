...
Revision ID: e957aca579e4
Revises: a60488369757
Create Date: 2024-10-17 09:19:39.557131
...
revision = 'e957aca579e4'
down_revision = 'a60488369757'
branch_labels = None
depends_on = None
...
def upgrade_():
    ...
    with op.batch_alter_table('registrations', schema=None) as batch_op:
        batch_op.alter_column('prereg_date_time',
