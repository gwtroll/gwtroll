...
class Invoice(db.Model):
    ...
    space_fee = db.Column(db.Double(), default=0)
    processing_fee = db.Column(db.Integer(), default=0)
    invoice_total = db.Column(db.Double(), Computed(registration_total+nmr_total+donation_total+space_fee+processing_fee))
...
class Payment(db.Model):
    ...
    space_fee_amount = db.Column(db.Double(), default=0)
...
class Merchant(db.Model):
    ...
    space_fee = db.Column(db.Double(), nullable=False, default=0.0)
    space_fee_balance = db.Column(db.Double(), nullable=False, default=0.0)
    ...
    electricity_fee = db.Column(db.Double(), nullable=False, default=0.0)
    electricity_balance = db.Column(db.Double(), nullable=False, default=0.0)
