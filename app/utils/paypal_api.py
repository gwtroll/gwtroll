...
def get_paypal_transactions(dt_start=None,dt_end=None):
    ...
    while start_date <= today:
        start_date_string = start_date.strftime("%Y-%m-%dT%H:%M:%S-0000") if dt_start == None else dt_start + "T00:00:00-0000"
        end_date_string = (start_date + timedelta(days=30)).strftime("%Y-%m-%dT%H:%M:%S-0000") if dt_end == None else dt_end + "T00:00:00-0000"
